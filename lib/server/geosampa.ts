...
function mapFichaParaGeoSampa(ficha: FichaCompleta, numProcesso?: string): IGeoSampaResult {
	...
	return {
		...
		calculo_outorga: ficha.calculo_outorga
			? {
					fp_uso_r: decimal(ficha.calculo_outorga.fp_uso_r),
					fp_uso_nr: decimal(ficha.calculo_outorga.fp_uso_nr),
					fs_uso_r: decimal(ficha.calculo_outorga.fs_uso_r),
					fs_uso_nr: decimal(ficha.calculo_outorga.fs_uso_nr),
					area_objeto_uso_r: decimal(ficha.calculo_outorga.area_objeto_uso_r),
					area_objeto_uso_nr: decimal(ficha.calculo_outorga.area_objeto_uso_nr),
					area_total_objeto: decimal(ficha.calculo_outorga.area_total_objeto),
					...
					percentual_fachada_ativa: decimal(ficha.calculo_outorga.percentual_fachada_ativa),
					contrapartida_uso_r: decimal(ficha.calculo_outorga.contrapartida_uso_r),
					contrapartida_uso_nr: decimal(ficha.calculo_outorga.contrapartida_uso_nr),
					contrapartida_total: decimal(ficha.calculo_outorga.contrapartida_total),
